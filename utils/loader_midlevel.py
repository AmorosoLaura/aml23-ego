...
class MidLevelLDataset(data.Dataset, ABC):
    def __init__(self, split, modalities, mode, dataset_conf, num_frames_per_clip, num_clips, dense_sampling,
        ...
        if self.load_feat:
            ...
            self.model_features = pd.DataFrame(pd.read_pickle(os.path.join(str(self.dataset_conf['FUSION'].data_path),
                                                                          self.dataset_conf['FUSION'].features_name + "_" +
    ...
    def __getitem__(self, index):
        ...
        sample['FUSION'] = sample_row["features_RGB"].values[0], sample_row["features_EMG"].values[0]
